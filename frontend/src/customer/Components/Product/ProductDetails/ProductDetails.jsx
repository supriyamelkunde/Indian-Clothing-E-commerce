              ...
              <Grid item xs={5}>
                ...
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">20659</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">19619</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">18949</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">17582</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">1909</p>
                    </Grid>
                  </Grid>
                </Box>
              </Grid>
